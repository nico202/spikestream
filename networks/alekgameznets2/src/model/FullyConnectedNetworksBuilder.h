#ifndef FULLYCONNECTEDNETWORKSBUILDER_H
#define FULLYCONNECTEDNETWORKSBUILDER_H
...
namespace spikestream {
	...
	class FullyConnectedNetworksBuilder : public QThread, public NetworksBuilder {
		Q_OBJECT

		public:
			FullyConnectedNetworksBuilder();
			~FullyConnectedNetworksBuilder();
...
#endif//FULLYCONNECTEDNETWORKSBUILDER_H
