...
void TononiNetworkBuilder::addBalduzziTononiFigure5(const QString& networkName, const QString& networkDescription){
    ...
    //3->4	3->5	3->6
    Connection* con34 = connGrp.addConnection(new Connection(neur3->getID(), neur4->getID(),  0,  0,  0));
    Connection* con35 = connGrp.addConnection(new Connection(neur3->getID(), neur5->getID(),  0,  0,  0));
    Connection* con36 = connGrp.addConnection(new Connection(neur3->getID(), neur6->getID(),  0,  0,  0));

    //4->3	4->5	4->6
    Connection* con43 = connGrp.addConnection(new Connection(neur4->getID(), neur3->getID(),  0,  0,  0));
    ...
    //5->3	5->4	5->6
    Connection* con53 = connGrp.addConnection(new Connection(neur5->getID(), neur3->getID(),  0,  0,  0));
    ...
    Connection* con67 = connGrp.addConnection(new Connection(neur6->getID(), neur7->getID(),  0,  0,  0));
    Connection* con68 = connGrp.addConnection(new Connection(neur6->getID(), neur8->getID(),  0,  0,  0));
    Connection* con610 = connGrp.addConnection(new Connection(neur6->getID(), neur10->getID(),  0,  0,  0));

    //7->6	7->8	7->10
    Connection* con76 = connGrp.addConnection(new Connection(neur7->getID(), neur6->getID(),  0,  0,  0));
    ...
    //8->6	8->7	8->10
    Connection* con86 = connGrp.addConnection(new Connection(neur8->getID(), neur6->getID(),  0,  0,  0));
    Connection* con87 = connGrp.addConnection(new Connection(neur8->getID(), neur7->getID(),  0,  0,  0));
    Connection* con810 = connGrp.addConnection(new Connection(neur8->getID(), neur10->getID(),  0,  0,  0));
    ...
    Connection* con108 = connGrp.addConnection(new Connection(neur10->getID(), neur8->getID(),  0,  0,  0));

    //9->7	11->9
    Connection* con97 = connGrp.addConnection(new Connection(neur9->getID(), neur7->getID(),  0,  0,  0));
    Connection* con119 = connGrp.addConnection(new Connection(neur11->getID(), neur9->getID(),  0,  0,  0));
...
void TononiNetworkBuilder::addBalduzziTononiFigure6(const QString& networkName, const QString& networkDescription){
    ...
    //Add connections
    Connection* con12 = connGrp.addConnection(new Connection(neuronMap[1]->getID(), neuronMap[2]->getID(),  0,  0,  0));
    Connection* con13 = connGrp.addConnection(new Connection(neuronMap[1]->getID(), neuronMap[3]->getID(),  0,  0,  0));
    Connection* con14 = connGrp.addConnection(new Connection(neuronMap[1]->getID(), neuronMap[4]->getID(),  0,  0,  0));
    Connection* con21 = connGrp.addConnection(new Connection(neuronMap[2]->getID(), neuronMap[1]->getID(),  0,  0,  0));
    Connection* con23 = connGrp.addConnection(new Connection(neuronMap[2]->getID(), neuronMap[3]->getID(),  0,  0,  0));
    Connection* con25 = connGrp.addConnection(new Connection(neuronMap[2]->getID(), neuronMap[5]->getID(),  0,  0,  0));
    Connection* con31 = connGrp.addConnection(new Connection(neuronMap[3]->getID(), neuronMap[1]->getID(),  0,  0,  0));
    Connection* con32 = connGrp.addConnection(new Connection(neuronMap[3]->getID(), neuronMap[2]->getID(),  0,  0,  0));
    Connection* con36 = connGrp.addConnection(new Connection(neuronMap[3]->getID(), neuronMap[6]->getID(),  0,  0,  0));
...
void TononiNetworkBuilder::addBalduzziTononiFigure12(const QString& networkName, const QString& networkDescription){
    ...
    //Add connections
    Connection* con17 = connGrp.addConnection(new Connection(neur1->getID(), neur7->getID(),  0,  0,  0));
    Connection* con21 = connGrp.addConnection(new Connection(neur2->getID(), neur1->getID(),  0,  0,  0));
    Connection* con34 = connGrp.addConnection(new Connection(neur3->getID(), neur4->getID(),  0,  0,  0));
    Connection* con37 = connGrp.addConnection(new Connection(neur3->getID(), neur7->getID(),  0,  0,  0));

    Connection* con38 = connGrp.addConnection(new Connection(neur3->getID(), neur8->getID(),  0,  0,  0));
    Connection* con42 = connGrp.addConnection(new Connection(neur4->getID(), neur2->getID(),  0,  0,  0));
    Connection* con54 = connGrp.addConnection(new Connection(neur5->getID(), neur4->getID(),  0,  0,  0));
    Connection* con62 = connGrp.addConnection(new Connection(neur6->getID(), neur2->getID(),  0,  0,  0));

    Connection* con65 = connGrp.addConnection(new Connection(neur6->getID(), neur5->getID(),  0,  0,  0));
    Connection* con78 = connGrp.addConnection(new Connection(neur7->getID(), neur8->getID(),  0,  0,  0));
    Connection* con81 = connGrp.addConnection(new Connection(neur8->getID(), neur1->getID(),  0,  0,  0));
    Connection* con85 = connGrp.addConnection(new Connection(neur8->getID(), neur5->getID(),  0,  0,  0));
