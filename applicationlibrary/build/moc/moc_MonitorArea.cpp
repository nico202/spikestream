...
static const char qt_meta_stringdata_MonitorArea[] = {
    "MonitorArea\0"
};

const QMetaObject MonitorArea::staticMetaObject = {
    { &Q3DockArea::staticMetaObject, qt_meta_stringdata_MonitorArea,
      qt_meta_data_MonitorArea, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MonitorArea))
        return static_cast<void*>(const_cast< MonitorArea*>(this));
    return Q3DockArea::qt_metacast(_clname);
}

int MonitorArea::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Q3DockArea::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
