...
/*! Constructor */
StateBasedPhiParameterDialog::StateBasedPhiParameterDialog(QWidget* parent, const AnalysisInfo &analysisInfo) : QDialog(parent){
    //Store variables
...
/*! Destructor */
StateBasedPhiParameterDialog::~StateBasedPhiParameterDialog(){
}
...
const AnalysisInfo& StateBasedPhiParameterDialog::getInfo(){
    return info;
}
...
void StateBasedPhiParameterDialog::okButtonClicked(){
    //Add the description
