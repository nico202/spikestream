...
namespace spikestream {
	...
	class NemoLoader : public QObject {
		...
		public:
			NemoLoader();
			~NemoLoader();
			nemo_network_t buildNemoNetwork(Network* network, QList<unsigned>* volatileConGrpList, const bool* stop);
		...
		private:
			...
			void addConnectionGroup(ConnectionGroup* conGroup, nemo_network_t nemoNetwork, QList<unsigned>* volatileConGrpList);
