...
/*! Constructor */
FullResultsTableView::FullResultsTableView(QWidget* parent, QAbstractTableModel* model) : QTableView(parent) {
	//Set up the view
	setShowGrid(false);
...
void FullResultsTableView::resizeHeaders(){
	...
	hHeader->resizeSection(hHeader->logicalIndex(2), 50);//Phi
...
void FullResultsTableView::tableClicked(QModelIndex index){
