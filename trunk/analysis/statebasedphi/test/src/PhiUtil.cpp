...
PhiCalculator* PhiUtil::buildPhiTestNetwork1(){
	...
	Util::addTraining(*weightlessNeuronMap[1], "0", 0);
	Util::addTraining(*weightlessNeuronMap[1], "1", 1);

	//Build neuron 2 - it copies the output from neuron 1
	conMap.clear();
	conMap[1].append(0);
	weightlessNeuronMap[2] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[2], "0", 0);
	Util::addTraining(*weightlessNeuronMap[2], "1", 1);

	//Build neuron 3 - it copies the output from neuron 4
	conMap.clear();
	conMap[4].append(0);
	weightlessNeuronMap[3] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[3], "0", 0);
	Util::addTraining(*weightlessNeuronMap[3], "1", 1);

	//Build neuron 4 - it copies the output from neuron 3
	conMap.clear();
	conMap[3].append(0);
	weightlessNeuronMap[4] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[4], "0", 0);
	Util::addTraining(*weightlessNeuronMap[4], "1", 1);
...
PhiCalculator* PhiUtil::buildPhiTestNetwork2(){
	...
	conMap[3].append(1);
	weightlessNeuronMap[1] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[1], "00", 0);
	Util::addTraining(*weightlessNeuronMap[1], "01", 0);
	Util::addTraining(*weightlessNeuronMap[1], "10", 0);
	Util::addTraining(*weightlessNeuronMap[1], "11", 1);
	...
	conMap[3].append(1);
	weightlessNeuronMap[2] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[2], "00", 0);
	Util::addTraining(*weightlessNeuronMap[2], "01", 0);
	Util::addTraining(*weightlessNeuronMap[2], "10", 0);
	Util::addTraining(*weightlessNeuronMap[2], "11", 1);
	...
	conMap[2].append(1);
	weightlessNeuronMap[3] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[3], "00", 0);
	Util::addTraining(*weightlessNeuronMap[3], "01", 0);
	Util::addTraining(*weightlessNeuronMap[3], "10", 0);
	Util::addTraining(*weightlessNeuronMap[3], "11", 1);
	...
	Util::addTraining(*weightlessNeuronMap[5], "0", 0);
	Util::addTraining(*weightlessNeuronMap[5], "1", 1);

	//Build neuron 6 - it copies the output from neuron 3
	conMap.clear();
	conMap[3].append(0);
	weightlessNeuronMap[6] = new WeightlessNeuron(conMap, 0);
	Util::addTraining(*weightlessNeuronMap[6], "0", 0);
	Util::addTraining(*weightlessNeuronMap[6], "1", 1);
