#ifndef NRMIMPORTWIDGET_H
#define NRMIMPORTWIDGET_H
...
namespace spikestream {
	...
	/*! Import wizard that enables user to import a set of NRM files specifying the configuration
		of an NRM network, the training of the network and data sets containing the firing patterns
		at different time steps. */
	class NRMImportWidget : public QWidget {
		Q_OBJECT
